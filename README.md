...
- turns out that the most one should ever throw given these rules is 16 dice. When that is the optimal decision though, the maximal probability of winning the game anyways is 3.19%. 


The biggest takeaways for me regarding this evaluation are that there still can be an optimal strategy even when there is randomness; and that the best decision to make changes depending on scenarios, sometimes drastically against the heuristic.
